...
public class DrawFence implements Command
{
    ...
    private void createConnectorForFence(MapSprite fromFence, MapSprite toFence, float fromX, float fromY, float toX, float toY, int stack)
    {
        ...
        connector.offsetMovebox1.setPosition(spriteVertices[SpriteBatch.X2] + map.cameraX + connector.x1Offset - (connector.offsetMovebox1.scale * connector.offsetMovebox1.width / 2f), spriteVertices[SpriteBatch.Y2] + map.cameraY + connector.y1Offset + Utils.getCameraHeightOffset(connector.layer) - (connector.offsetMovebox1.scale * connector.offsetMovebox1.height / 2f));
        connector.offsetMovebox2.setPosition(spriteVertices[SpriteBatch.X3] + map.cameraX + connector.x2Offset - (connector.offsetMovebox2.scale * connector.offsetMovebox2.width / 2f), spriteVertices[SpriteBatch.Y3] + map.cameraY + connector.y2Offset + Utils.getCameraHeightOffset(connector.layer) - (connector.offsetMovebox2.scale * connector.offsetMovebox2.height / 2f));
        connector.offsetMovebox3.setPosition(spriteVertices[SpriteBatch.X4] + map.cameraX + connector.x3Offset - (connector.offsetMovebox3.scale * connector.offsetMovebox3.width / 2f), spriteVertices[SpriteBatch.Y4] + map.cameraY + connector.y3Offset + Utils.getCameraHeightOffset(connector.layer) - (connector.offsetMovebox3.scale * connector.offsetMovebox3.height / 2f));
        connector.offsetMovebox4.setPosition(spriteVertices[SpriteBatch.X1] + map.cameraX + connector.x4Offset - (connector.offsetMovebox4.scale * connector.offsetMovebox4.width / 2f), spriteVertices[SpriteBatch.Y1] + map.cameraY + connector.y4Offset + Utils.getCameraHeightOffset(connector.layer) - (connector.offsetMovebox4.scale * connector.offsetMovebox4.height / 2f));
