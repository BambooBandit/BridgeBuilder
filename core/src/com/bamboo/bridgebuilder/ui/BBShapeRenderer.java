 ...
 * @author stbachmann
 * @author Nathan Sweet */
public class BBShapeRenderer implements Disposable {
    ...
    public BBShapeRenderer () {
        this(5000);
    }

    public BBShapeRenderer (int maxVertices) {
        this(maxVertices, null);
    }

    public BBShapeRenderer (int maxVertices, ShaderProgram defaultShader) {
